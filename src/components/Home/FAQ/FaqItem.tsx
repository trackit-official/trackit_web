    ...
    <>
      <div className="rounded-lg bg-white shadow-1 dark:bg-gray-dark">
        <button
          ...
          className={`text-medium flex w-full items-center justify-between px-6 py-4 text-left text-lg font-satoshi text-dark dark:text-white md:text-xl`}
        >
          {question}
        ...
        >
          <div className={`overflow-hidden transition-all duration-300`}>
            <p
              className={`border-t border-stroke px-6 py-7 font-satoshi dark:border-stroke-dark`}
            >
              {answer}
            </p>
          </div>
